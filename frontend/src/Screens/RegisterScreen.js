        ...
        <div className='w-96 bg-white rounded-xl mx-auto shadow-lg overflow-hidden'>
          <div className='py-10 px-12'>
              ...
              <form onSubmit={submitHandler}>
                  <div className='mt-4'>
                      <input type='text' placeholder='Name' className='border border-grey-400 py-1 px-2 w-full' value={name} onChange={(e) => { setName(e.target.value) }} />
                  </div>
                  <div className='mt-4'>
                  ...
                  <div className='mt-4 mb-3'>
                      <span>Already have Account? <Link to='/login' className='font-semibold text-blue-500'>Login</Link></span>
                  </div>
              </form>
          </div>
        </div>
